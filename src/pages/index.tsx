    ...
    <Layout>
      ...
      <section className="container mx-auto py-8">
        ...
        <p className="text-right mt-8">
          ปัจจุบันค่าเฟ่ และห้องสมุดของเรา อยู่ในช่วงการดูแลของ นายภัทร์สรรพ์พร นครานุรักษ์ รหัสนักศึกษา 65070171
          {' '}ซึ่งมีบริการการชงกาแฟถึงมือลูกค้า แบบจับมือชงที่ไม่เคยเห็นมาก่อนในจักรภพสุริยะนี้ ทุกท่านจะได้รับประสบการณ์ใหม่ๆ ที่ไม่เคยเห็นมาก่อน การันตีโดยอาจารย์ปานวิทย์
        </p>
      </section>
    </Layout>
  );
